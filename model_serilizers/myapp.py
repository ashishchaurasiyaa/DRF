...
if __name__ == "__main__":
    ...
    # Post new data
    # response_content, content_type = client.post_data({'name': 'Ashish', 'roll': 102, 'city': 'New Delhi'})
    # handle_response(response_content, content_type)

    # # Update data with id=1
    response_content, content_type = client.update_data({'id': 1, 'name': 'Ajay', 'city': 'New York'})
    handle_response(response_content, content_type)
